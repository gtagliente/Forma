...
using Forma.Query.Data.Repositories;
using Forma.Query.Data.Repositories.Abstractions;

namespace Forma.Query;
...
public static class ConfigureServices
{
    ...
    public static IServiceCollection AddReadOnlyRepositories(this IServiceCollection services) =>
        services
            .AddScoped<IWorkoutReadOnlyRepository, WorkoutReadOnlyRepository>()
            .AddScoped<IRoutineReadOnlyRepository, RoutineReadOnlyRepository>();
